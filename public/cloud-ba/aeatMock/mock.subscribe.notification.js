// Should randomly generate some new version of AEAT
// and push it to open socket
// when file s generated new single-trigger.json should appear in dynamic folder
let timeoutInterval;

const startInjectingAlerts = (ws) => {
  ws.on('close', () => {
...
module.exports = startInjectingAlerts;

const aeat = `<AEAT xmlns="tag:atsc.org,2016:XMLSchemas/ATSC3/Delivery/AEAT/1.0/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
...
<EventCode type="SAME">DMO</EventCode>
...
<AEA aeaId="6f9eba99-4567-41bf-9740-3a6518ffd1bb_124d4d02-7739-44aa-b3ec-394da47fac7b" refAEAId="6f9eba99-3546-41bf-9740-3a6518ffd1bb_124d4d02-7739-44aa-b3ec-394da47fac7b" aeaType="update" audience="public" issuer="nextgenbroadcast.com" priority="3" wakeup="false">
<Header effective="${new Date().toISOString()}" expires="2022-12-31T17:46:54+00:00">
<EventCode type="SAME">BNF</EventCode>
<EventDesc xml:lang="en">BROADCAST NEWS FLASH</EventDesc>
<Location type="FIPS">032003</Location>
<Location type="FIPS">032023</Location>
